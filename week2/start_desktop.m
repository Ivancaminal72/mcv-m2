clearvars;
dst = double(imread('../data/custom/google/desktop.png'));
src = double(imread('../data/custom/google/google.png')); % flipped girl, because of the eyes
size(dst)
size(src)
...
mask_dst = logical(generate_mask(800, 1280, 830, 300, 139,112));
mask_src = logical(generate_mask(800, 1280, 495, 300, 265,112));
...
% imshow(mask_src)
% subplot(1,3,3)
% imshow(imread('../data/custom/google/google.png'))
